...
test('cluster.network', (t) => {
    ...
    popQ.defer((done) => {
        pool.query(`
            BEGIN;
            INSERT INTO network (id, names, geom) VALUES (2, '[{ "tokenized": [{ "token": "main", "token_type": null }, { "token": "st", "token_type": "Way" }], "display": "Main Street", "freq": 1, "priority": 0 }]', ST_SetSRID(ST_GeomFromGeoJSON('{ "type": "MultiLineString", "coordinates": [ [ [ -66.053903103, 45.269616328 ], [ -66.054418087, 45.271035833 ] ] ]}'), 4326));
            INSERT INTO network (id, names, geom) VALUES (2, '[{ "tokenized": [{ "token": "main", "token_type": null }, { "token": "st", "token_type": "Way" }], "display": "Main Street", "freq": 1, "priority": 0 }]', ST_SetSRID(ST_GeomFromGeoJSON('{ "type": "MultiLineString", "coordinates": [ [ [ -66.054353714, 45.271005631 ], [ -66.054933071, 45.272455302 ] ] ]}'), 4326));
            INSERT INTO network (id, names, geom) VALUES (1, '[{ "tokenized": [{ "token": "main", "token_type": null }, { "token": "st", "token_type": "Way" }], "display": "Main Street", "freq": 1, "priority": 0 }]', ST_SetSRID(ST_GeomFromGeoJSON('{ "type": "MultiLineString", "coordinates": [ [ [ -113.501172066, 53.551374138 ], [ -113.501129150, 53.548365493 ] ] ]}'), 4326));
            INSERT INTO network (id, names, geom) VALUES (1, '[{ "tokenized": [{ "token": "main", "token_type": null }, { "token": "st", "token_type": "Way" }], "display": "Main Street", "freq": 1, "priority": 0 }]', ST_SetSRID(ST_GeomFromGeoJSON('{ "type": "MultiLineString", "coordinates": [ [ [ -113.501000404, 53.548365493 ], [ -113.501043321, 53.546147118 ] ] ]}'), 4326));
            COMMIT;
        `, (err) => {
            t.error(err, 'no errors');
